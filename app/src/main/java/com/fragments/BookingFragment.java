...
import com.app85taxi.driver.HistoryActivity;
                        ...
                        if (arr_rides != null && arr_rides.length() > 0) {
                            for (int i = 0; i < arr_rides.length(); i++) {
                                ...
                                if (isDeliver()) {
                                    ...
                                    map.put("LBL_START_TRIP", generalFunc.retrieveLangLBl("Start Delivery", "LBL_START_DELIVERY"));
                                    ...
                                    map.put("LBL_START_TRIP", generalFunc.retrieveLangLBl("", "LBL_START_TRIP"));
