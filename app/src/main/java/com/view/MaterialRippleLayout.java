...
public class MaterialRippleLayout extends FrameLayout {
    ...
    private boolean isMButton_type_1;
    private boolean isMButton_type_2;
    ...
    public MaterialRippleLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        isMButton_type_1 = a.getBoolean(R.styleable.MaterialRippleLayout_met_isMButton_type1, false);
        isMButton_type_2 = a.getBoolean(R.styleable.MaterialRippleLayout_met_isMButton_type2, false);

        if (isMButton_type_1 == true) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View view = inflater.inflate(R.layout.btn_type_1_design, null);
            this.addView(view,new ViewGroup.LayoutParams(MATCH_PARENT, MATCH_PARENT));

        } else if (isMButton_type_2 == true) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View view = inflater.inflate(R.layout.btn_type_2_design, null);
            this.addView(view, new ViewGroup.LayoutParams(MATCH_PARENT, MATCH_PARENT));
...
//        if (!isEnabled() || !childView.isEnabled()) return superOnTouchEvent;
        if (!isEnabled() || !childView.isEnabled()) return true;
    ...
    private void startRipple(final Runnable animationEndRunnable) {
        ...
        /* Start - add to disable click on child view to prevent double tap */
        childView.setEnabled(false);
        /* End- add to disable click on child view to prevent double tap */
        ...
        rippleAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                 ...
                 /* Start - Re-enable child view */
                childView.setEnabled(true);
                /* End- Re-enable child view */
