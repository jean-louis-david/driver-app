...
public class MaterialTabs extends HorizontalScrollView {
    ...
    public MaterialTabs(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColorUnselected = a.getColor(R.styleable.MaterialTabs_mtTextColorUnSelected, tabTextColorUnselected);
        ...
        rippleRoundedCornersDp = a.getDimension(R.styleable.MaterialTabs_mtMrlRippleRoundedCorners, MaterialRippleLayout.DEFAULT_ROUNDED_CORNERS);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            MaterialRippleLayout materialRippleLayout = MaterialRippleLayout.on(tabView)
                    ...
                    .rippleDiameterDp((int) rippleDiameterDp)
                    ...
                    .rippleRoundedCorners((int) rippleRoundedCornersDp)
                    .create();
