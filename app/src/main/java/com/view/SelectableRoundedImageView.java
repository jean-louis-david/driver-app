...
public class SelectableRoundedImageView extends ImageView {
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                Utils.printLog(TAG, "Unable to find resource: " + mResource+e.toString());
                // Don't try again.
                mResource = 0;
            }
        }
    ...
    static class SelectableRoundedCornerDrawable extends Drawable {
        ...
        private static final String TAG = "SelectableRoundedCD";
        private static final int DEFAULT_BORDER_COLOR = Color.BLACK;
        ...
        public static Drawable fromDrawable(Drawable drawable, Resources r) {
            if (drawable != null) {
                ...
                if (bm != null) {
                    ...
                    Utils.printLog(TAG, "Failed to create bitmap!");
                }
            }
            return drawable;
        }
