package com.view.slidinguppanel;
...
//    private static final int DEFAULT_FADE_COLOR = 0x99000000;
    ...
    Canvas drawChild_canvas;
    View drawChild_view;
    long drawChild_drawingTime;

    int measure_widthMeasureSpec;
    int measure_heightMeasureSpec;
    ...
    public void setPanelHeight(int val,boolean isCollapse) {
        if (getPanelHeight() == val) {
            return;
        }
...
//                    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.measure_widthMeasureSpec = widthMeasureSpec;
        this.measure_heightMeasureSpec = heightMeasureSpec;
...
//            mSlideState = PanelState.HIDDEN;
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        this.drawChild_canvas = canvas;
        this.drawChild_view = child;
        this.drawChild_drawingTime = drawingTime;
