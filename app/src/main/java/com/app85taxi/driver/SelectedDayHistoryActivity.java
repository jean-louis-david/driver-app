...
public class SelectedDayHistoryActivity extends AppCompatActivity {
    ...
    public void setLabels() {
        //titleTxt.setText(generalFunc.retrieveLangLBl("Daily Earnings", "LBL_DAILY_EARNING"));
    ...
    public void setData(boolean isDataAvail, String responseString) {
        ...
        if (isDataAvail) {
            ...
            ((MTextView) findViewById(R.id.noRidesFound)).setText(generalFunc.retrieveLangLBl("", "LBL_NO_RIDES_TXT"));
        ...
        //titleTxt.setText(generalFunc.getJsonValue("TripDate", responseString));
