...
//
//        final File sdImageMainDirectory = new File(storageDir, fileName);
...
//        cameraIntents.add(fsIntent);
    ...
    public void checkData() {
        ...
        if (!getIntent().getStringExtra("doc_file").equals("")) {
            ...
            if(isuploadimageNew) {
                new UploadProfileImage(UploadDocActivity.this, selectedDocumentPath, Utils.TempProfileImageName, paramsList, "FILE").execute();
            }
            else
        ...
        if (requestCode == PICK_FILE_REQUEST_CODE && resultCode == RESULT_OK/* && data != null*/) {
            ...
            if(filePath!=null) {
                if (Utils.getFileExt(filePath).equalsIgnoreCase("jpg") || Utils.getFileExt(filePath).equalsIgnoreCase("gif") || Utils.getFileExt(filePath).equalsIgnoreCase("png")
                        ...
                        || Utils.getFileExt(filePath).equalsIgnoreCase("xls") || Utils.getFileExt(filePath).equalsIgnoreCase("xlxs")) {
