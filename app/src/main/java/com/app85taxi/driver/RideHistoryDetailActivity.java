...
public class RideHistoryDetailActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.setListener(new ScrollSupportMapFragment.OnTouchListener() {
            @Override
            public void onTouch() {
    ...
    public void setData() {
        ...
        ((MTextView) findViewById(R.id.tripdateVTxt)).setText(generalFunc.getDateFormatedType(generalFunc.getJsonValue("tTripRequestDateOrig", tripData), Utils.OriginalDateFormate, Utils.dateFormateInList));
...
//            findViewById(R.id.tripDetailArea).setVisibility(View.GONE);
            ...
            ((MTextView) findViewById(R.id.pickUpVTxt)).setText(generalFunc.getJsonValue("tDaddress", tripData));
