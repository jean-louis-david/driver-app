...
public class ManageVehiclesActivity extends AppCompatActivity implements VehicleListAdapter.OnItemClickList {
    ...
    public void getData() {
        ...
        parameters.put("MemberType", CommonUtilities.app_type);
//        parameters.put("page", "");
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.rightImgView:
                    (new StartActProcess(getActContext())).startActForResult(AddVehicleActivity.class, Utils.ADD_VEHICLE_REQ_CODE);
                    break;
