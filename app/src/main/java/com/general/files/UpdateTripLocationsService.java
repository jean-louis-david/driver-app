...
public class UpdateTripLocationsService extends Service implements UpdateFrequentTask.OnTaskRunCalled, GetLocationUpdates.LocationUpdates {
    ...
    int LOCATION_ACCURACY_METERS = 1000;
    ...
    public void startUpdate(String generatedTripId) {
        ...
        LOCATION_ACCURACY_METERS = generalFunc.parseIntegerValue(1000, generalFunc.retrieveValue("LOCATION_ACCURACY_METERS"));

        updateDriverLocationsTask = new UpdateFrequentTask(UPDATE_TIME_INTERVAL);
        updateDriverLocationsTask.setTaskRunListener(this);

        getLocationUpdates = new GetLocationUpdates(this, Utils.LOCATION_UPDATE_MIN_DISTANCE_IN_MITERS, true);
    ...
    void startFreqTask() {
        ...
        if (getLocationUpdates == null) {
            getLocationUpdates = new GetLocationUpdates(this, 5, true);
            getLocationUpdates.setLocationUpdatesListener(this);
        }
    }
