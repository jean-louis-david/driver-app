...
//        remoteViews.setOnClickPendingIntent(R.id.goOfflineBtn, pendingIntentOffline);
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(getServiceContext()).setSmallIcon(R.mipmap.ic_launcher)
                .setContentTitle(getServiceContext().getString(R.string.app_name)).setContentText("App goes into background")
                .setOngoing(true)
